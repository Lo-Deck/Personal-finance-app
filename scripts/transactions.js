...
function feedTransactionPage(data){
    ...
    if(transactions.length > 10){
        ...
        liPrevious.classList.add('li-page', 'previous');
        liPrevious.innerHTML = `<button type="button" class="button previous" aria-label="Page previous" data-page="previous"><svg fill="none" height="11" viewBox="0 0 6 11" width="6" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        ul.addEventListener('click', (event) => {
            ...
            if(button){
                ...
                /********  FAIRE LES PREVIOUS ET NEXT DISBLED  ET CHECK FONCTIONNEMENT *******/
